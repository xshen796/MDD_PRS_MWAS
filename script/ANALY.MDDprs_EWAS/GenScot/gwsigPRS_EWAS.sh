...
stradl_ewas --pdata /exports/eddie/scratch/xshen33/GS_PRS_loo/PRS_allpT/MDDprs_gwsigSNP_forEWAS.txt --pheno Pt_5e.08 --cov /exports/igmm/eddie/GenScotDepression/shen/ActiveProject/Genetic/MDD_PRS_MWAS/data/GS_phenotype/covs_geneticPC_RosieData_wave1.rds --no-prune --out ewas_w1_gwsig

stradl_ewas_w3 --pdata /exports/eddie/scratch/xshen33/GS_PRS_loo/PRS_allpT/MDDprs_gwsigSNP_forEWAS.txt --pheno Pt_5e.08 --cov /exports/igmm/eddie/GenScotDepression/shen/ActiveProject/Genetic/MDD_PRS_MWAS/data/GS_phenotype/covs_geneticPC_RosieData_wave3.rds --no-prune --out ewas_w3_gwsig
