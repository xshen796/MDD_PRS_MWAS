...
--phenoFile=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/pheno/MD_ATR_forGWAS.tsv \
--phenoCol=MD_ATR \
...
--qCovarCol=pos.z \
--qCovarCol=pos.table \
--statsFile=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/MD_ATR.bolt.bed.stats.gz \
--statsFileBgenSnps=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/MD_ATR.bolt.bed.stats.gz \
