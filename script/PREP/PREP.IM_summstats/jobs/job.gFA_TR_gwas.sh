...
--phenoFile=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/pheno/gFA_TR_forGWAS.tsv \
--phenoCol=gFA_TR \
...
--qCovarCol=pos.z \
--qCovarCol=pos.table \
--statsFile=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/gFA_TR.bolt.bed.stats.gz \
--statsFileBgenSnps=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/gFA_TR.bolt.bed.stats.gz \
