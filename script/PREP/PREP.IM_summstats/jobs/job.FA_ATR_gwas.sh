...
--phenoFile=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/pheno/FA_ATR_forGWAS.tsv \
--phenoCol=FA_ATR \
...
--qCovarCol=pos.z \
--qCovarCol=pos.table \
--statsFile=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/FA_ATR.bolt.bed.stats.gz \
--statsFileBgenSnps=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/FA_ATR.bolt.bed.stats.gz \
