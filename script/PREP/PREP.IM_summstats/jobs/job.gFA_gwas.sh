...
--phenoFile=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/pheno/gFA_forGWAS.tsv \
--phenoCol=gFA \
...
--qCovarCol=pos.z \
--qCovarCol=pos.table \
--statsFile=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/gFA.bolt.bed.stats.gz \
--statsFileBgenSnps=/exports/igmm/eddie/GenScotDepression/shen/bakup.dat/UKB_IM_summstats/local_GWAS/gFA.bolt.bed.stats.gz \
