...
Rscript PREP.exposure.R --mqtl /exports/igmm/eddie/GenScotDepression/shen/ActiveProject/Genetic/MR_meth_MDD/data/mQTL/mQTL_forMR/ \
...
while read targetfile; do
    ...
    --outcomeName ${result_tag} \
    --outputfig /exports/igmm/eddie/GenScotDepression/shen/ActiveProject/Genetic/MR_meth_MDD/result/GoDMC_MR_DNAm_to_MDD/DNAm_to_${result_tag}_figs/ \
    --outputtable /exports/igmm/eddie/GenScotDepression/shen/ActiveProject/Genetic/MR_meth_MDD/result/GoDMC_MR_DNAm_to_MDD/Summary_DNAm_to_${result_tag}.csv \
